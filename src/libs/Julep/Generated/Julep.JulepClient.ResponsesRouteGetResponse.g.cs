...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        partial void PrepareResponsesRouteGetResponseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::System.Collections.Generic.IList<global::Julep.ResponsesIncludable>? include);
        partial void ProcessResponsesRouteGetResponseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessResponsesRouteGetResponseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.ResponsesResponse> ResponsesRouteGetResponseAsync(
            string id,
        ...
        {
            var __response = await ResponsesRouteGetResponseAsResponseAsync(
                id: id,
                include: include,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.ResponsesResponse>> ResponsesRouteGetResponseAsResponseAsync(
            string id,
            global::System.Collections.Generic.IList<global::Julep.ResponsesIncludable>? include = default,
            global::Julep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareResponsesRouteGetResponseArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ResponsesRouteGetResponse",
                                methodName: "ResponsesRouteGetResponseAsync",
                                pathTemplate: "$\"/responses/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessResponsesRouteGetResponseResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessResponsesRouteGetResponseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Julep.ResponsesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Julep.AutoSDKHttpResponse<global::Julep.ResponsesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Julep.ResponsesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
