...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_TasksRouteUpdateSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_TasksRouteUpdateSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_TasksRouteUpdateSecurityRequirement0,
            };
        ...
        {
            var __response = await TasksRouteUpdateAsResponseAsync(
                id: id,
                childId: childId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.TasksTask>> TasksRouteUpdateAsResponseAsync(
            global::System.Guid id,
            global::System.Guid childId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TasksRouteUpdateSecurityRequirements,
                operationName: "TasksRouteUpdateAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TasksRouteUpdate",
                                methodName: "TasksRouteUpdateAsync",
