...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_TaskExecutionsRouteListSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_TaskExecutionsRouteListSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_TaskExecutionsRouteListSecurityRequirement0,
            };
        partial void PrepareTaskExecutionsRouteListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref int limit,
            ref int offset,
            ref global::Julep.TaskExecutionsRouteListSortBy sortBy,
            ref global::Julep.TaskExecutionsRouteListDirection direction,
            object metadataFilter);
        partial void PrepareTaskExecutionsRouteListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            int limit,
            int offset,
            global::Julep.TaskExecutionsRouteListSortBy sortBy,
            global::Julep.TaskExecutionsRouteListDirection direction,
            object metadataFilter);
        partial void ProcessTaskExecutionsRouteListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTaskExecutionsRouteListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.TaskExecutionsRouteListResponse> TaskExecutionsRouteListAsync(
            global::System.Guid id,
            int limit,
            int offset,
            object metadataFilter,
        ...
        {
            var __response = await TaskExecutionsRouteListAsResponseAsync(
                id: id,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.TaskExecutionsRouteListResponse>> TaskExecutionsRouteListAsResponseAsync(
            global::System.Guid id,
            int limit,
            int offset,
            object metadataFilter,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTaskExecutionsRouteListArguments(
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TaskExecutionsRouteListSecurityRequirements,
                operationName: "TaskExecutionsRouteListAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TaskExecutionsRouteList",
                                methodName: "TaskExecutionsRouteListAsync",
                                pathTemplate: "$\"/tasks/{id}/executions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTaskExecutionsRouteListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTaskExecutionsRouteListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Julep.TaskExecutionsRouteListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Julep.AutoSDKHttpResponse<global::Julep.TaskExecutionsRouteListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Julep.TaskExecutionsRouteListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
