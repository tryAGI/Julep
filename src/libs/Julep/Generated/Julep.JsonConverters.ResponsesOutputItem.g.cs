...
namespace Julep.JsonConverters
{
    ...
    public class ResponsesOutputItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Julep.ResponsesOutputItem>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        message = global::System.Text.Json.JsonSerializer.Deserialize<global::Julep.ResponsesOutputMessage>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 5)
                {
                    try
                    {
                        reasoning = global::System.Text.Json.JsonSerializer.Deserialize<global::Julep.ResponsesReasoningItem>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsMessage)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Message, typeof(global::Julep.ResponsesOutputMessage), options);
            }
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Reasoning, typeof(global::Julep.ResponsesReasoningItem), options);
            }
        }
    }
}