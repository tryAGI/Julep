...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_AgentSecretsRouteListSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_AgentSecretsRouteListSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_AgentSecretsRouteListSecurityRequirement0,
            };
        partial void PrepareAgentSecretsRouteListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref int limit,
            ref int offset,
            ref global::Julep.AgentSecretsRouteListSortBy sortBy,
            ref global::Julep.AgentSecretsRouteListDirection direction,
            object metadataFilter);
        partial void PrepareAgentSecretsRouteListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            int limit,
            int offset,
            global::Julep.AgentSecretsRouteListSortBy sortBy,
            global::Julep.AgentSecretsRouteListDirection direction,
            object metadataFilter);
        partial void ProcessAgentSecretsRouteListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentSecretsRouteListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.AgentSecretsRouteListResponse> AgentSecretsRouteListAsync(
            global::System.Guid id,
            int limit,
            int offset,
            object metadataFilter,
        ...
        {
            var __response = await AgentSecretsRouteListAsResponseAsync(
                id: id,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.AgentSecretsRouteListResponse>> AgentSecretsRouteListAsResponseAsync(
            global::System.Guid id,
            int limit,
            int offset,
            object metadataFilter,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentSecretsRouteListArguments(
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentSecretsRouteListSecurityRequirements,
                operationName: "AgentSecretsRouteListAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentSecretsRouteListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentSecretsRouteList",
                                methodName: "AgentSecretsRouteListAsync",
                                pathTemplate: "$\"/agents/{id}/secrets\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentSecretsRouteListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentSecretsRouteListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Julep.AgentSecretsRouteListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Julep.AutoSDKHttpResponse<global::Julep.AgentSecretsRouteListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Julep.AgentSecretsRouteListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
