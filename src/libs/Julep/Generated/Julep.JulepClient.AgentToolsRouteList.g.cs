...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_AgentToolsRouteListSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_AgentToolsRouteListSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_AgentToolsRouteListSecurityRequirement0,
            };
        partial void PrepareAgentToolsRouteListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            ref int limit,
            ref int offset,
            ref global::Julep.AgentToolsRouteListSortBy sortBy,
            ref global::Julep.AgentToolsRouteListDirection direction,
            object metadataFilter);
        partial void PrepareAgentToolsRouteListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            int limit,
            int offset,
            global::Julep.AgentToolsRouteListSortBy sortBy,
            global::Julep.AgentToolsRouteListDirection direction,
            object metadataFilter);
        partial void ProcessAgentToolsRouteListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentToolsRouteListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.AgentToolsRouteListResponse> AgentToolsRouteListAsync(
            global::System.Guid id,
            int limit,
            int offset,
            object metadataFilter,
        ...
        {
            var __response = await AgentToolsRouteListAsResponseAsync(
                id: id,
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.AgentToolsRouteListResponse>> AgentToolsRouteListAsResponseAsync(
            global::System.Guid id,
            int limit,
            int offset,
            object metadataFilter,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentToolsRouteListArguments(
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentToolsRouteListSecurityRequirements,
                operationName: "AgentToolsRouteListAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentToolsRouteList",
                                methodName: "AgentToolsRouteListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentToolsRouteListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentToolsRouteListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Julep.AgentToolsRouteListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Julep.AutoSDKHttpResponse<global::Julep.AgentToolsRouteListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Julep.AgentToolsRouteListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
