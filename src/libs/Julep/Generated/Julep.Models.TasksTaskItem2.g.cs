...
namespace Julep
{
    ...
    public sealed partial class TasksTaskItem2
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Julep.JsonConverters.TasksTaskItemKindJsonConverter))]
        public global::Julep.TasksTaskItemKind Kind { get; set; } = default!;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TasksTaskItem2" /> class.
        /// </summary>
        /// <param name="over">
        /// The variable to iterate over
        /// </param>
        ...
        public TasksTaskItem2(
            ...
            object? initial,
            int? parallelism,
            global::Julep.TasksTaskItemKind kind = default!)
        {
            this.Kind = kind;
