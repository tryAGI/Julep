...
namespace Julep
{
    ...
    public sealed partial class DocsHybridDocSearchRequest
    {
        ...
        /// <summary>
        /// The k_multiplier to control how many intermediate results to fetch before final scoring<br/>
        /// Default Value: 5
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocsHybridDocSearchRequest" /> class.
        /// </summary>
        /// <param name="limit">
        /// The limit of documents to return<br/>
        /// Default Value: 10
...
#endif
        public DocsHybridDocSearchRequest(
            int limit,
