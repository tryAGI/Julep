...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_UsersRouteListSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_UsersRouteListSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_UsersRouteListSecurityRequirement0,
            };
        ...
        {
            var __response = await UsersRouteListAsResponseAsync(
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.UsersRouteListResponse>> UsersRouteListAsResponseAsync(
            int limit,
            int offset,
            object metadataFilter,
            global::Julep.UsersRouteListSortBy sortBy = global::Julep.UsersRouteListSortBy.CreatedAt,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UsersRouteListSecurityRequirements,
                operationName: "UsersRouteListAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UsersRouteList",
                                methodName: "UsersRouteListAsync",
                                pathTemplate: "\"/users\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Julep.UsersRouteListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Julep.AutoSDKHttpResponse<global::Julep.UsersRouteListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Julep.UsersRouteListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
