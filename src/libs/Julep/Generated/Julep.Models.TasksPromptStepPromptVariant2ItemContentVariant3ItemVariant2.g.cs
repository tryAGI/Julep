...
namespace Julep
{
    ...
    public sealed partial class TasksPromptStepPromptVariant2ItemContentVariant3ItemVariant2
    {
        ...
        /// <summary>
        /// Creates a new <see cref="TasksPromptStepPromptVariant2ItemContentVariant3ItemVariant2"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static TasksPromptStepPromptVariant2ItemContentVariant3ItemVariant2 FromImageUrl(global::Julep.TasksPromptStepPromptVariant2ItemContentVariant3ItemVariant2ImageUrl imageUrl)
        {
            return new TasksPromptStepPromptVariant2ItemContentVariant3ItemVariant2
            {
                ImageUrl = imageUrl,
            };
        }
