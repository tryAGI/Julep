...
namespace Julep
{
    ...
    public sealed partial class ChatMultipleChatOutputMessageContentVariant3ItemVariant2ImageUrl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatMultipleChatOutputMessageContentVariant3ItemVariant2ImageUrl" /> class.
        /// </summary>
        /// <param name="url">
        /// Image URL or base64 data url (e.g. `data:image/jpeg;base64,&lt;the base64 encoded image&gt;`)
        /// </param>
...
#endif
        public ChatMultipleChatOutputMessageContentVariant3ItemVariant2ImageUrl(
            string url,
