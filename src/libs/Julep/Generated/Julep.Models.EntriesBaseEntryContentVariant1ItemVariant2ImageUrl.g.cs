...
namespace Julep
{
    ...
    public sealed partial class EntriesBaseEntryContentVariant1ItemVariant2ImageUrl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntriesBaseEntryContentVariant1ItemVariant2ImageUrl" /> class.
        /// </summary>
        /// <param name="url">
        /// Image URL or base64 data url (e.g. `data:image/jpeg;base64,&lt;the base64 encoded image&gt;`)
        /// </param>
...
#endif
        public EntriesBaseEntryContentVariant1ItemVariant2ImageUrl(
            string url,
