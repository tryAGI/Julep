...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_ProjectsRoutePatchSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_ProjectsRoutePatchSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_ProjectsRoutePatchSecurityRequirement0,
            };
        partial void PrepareProjectsRoutePatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            global::Julep.ProjectsPatchProjectRequest request);
        partial void PrepareProjectsRoutePatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            global::Julep.ProjectsPatchProjectRequest request);
        partial void ProcessProjectsRoutePatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsRoutePatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.ProjectsProject> ProjectsRoutePatchAsync(
            global::System.Guid id,
        ...
        {
            var __response = await ProjectsRoutePatchAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.ProjectsProject>> ProjectsRoutePatchAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsRoutePatchArguments(
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectsRoutePatchSecurityRequirements,
                operationName: "ProjectsRoutePatchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProjectsRoutePatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsRoutePatch",
                                methodName: "ProjectsRoutePatchAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectsRoutePatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsRoutePatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.ProjectsProject> ProjectsRoutePatchAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Julep.ProjectsPatchProjectRequest
            {
                Metadata = metadata,
            ...
            return await ProjectsRoutePatchAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
