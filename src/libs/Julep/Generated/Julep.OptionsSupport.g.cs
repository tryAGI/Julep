...
namespace Julep
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Julep.AutoSDKRetryOptions Retry { get; set; } = new global::Julep.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Julep.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Julep.IAutoSDKHook>();
        ...
        public global::Julep.AutoSDKClientOptions AddHook(
            global::Julep.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Julep.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Julep.AutoSDKClientOptions UseAuthorizationProvider(
            global::Julep.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Julep.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Julep.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Julep.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Julep.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Julep.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Julep.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Julep.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Julep.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Julep.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Julep.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Julep.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Julep.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Julep.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Julep.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Julep.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Julep.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Julep.AutoSDKClientOptions clientOptions,
            global::Julep.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Julep.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Julep.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Julep.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Julep.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Julep.IAutoSDKHook, global::Julep.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Julep.AutoSDKHookContext context)
        {
