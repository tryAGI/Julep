...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_ProjectsRouteCreateSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_ProjectsRouteCreateSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_ProjectsRouteCreateSecurityRequirement0,
            };
        partial void PrepareProjectsRouteCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Julep.ProjectsCreateProjectRequest request);
        partial void PrepareProjectsRouteCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Julep.ProjectsCreateProjectRequest request);
        partial void ProcessProjectsRouteCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectsRouteCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.ProjectsProject> ProjectsRouteCreateAsync(

            global::Julep.ProjectsCreateProjectRequest request,
            global::Julep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ProjectsRouteCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.ProjectsProject>> ProjectsRouteCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProjectsRouteCreateArguments(
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectsRouteCreateSecurityRequirements,
                operationName: "ProjectsRouteCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProjectsRouteCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectsRouteCreate",
                                methodName: "ProjectsRouteCreateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectsRouteCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectsRouteCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.ProjectsProject> ProjectsRouteCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Julep.ProjectsCreateProjectRequest
            {
                Metadata = metadata,
            ...
            return await ProjectsRouteCreateAsync(
                request: __request,
                requestOptions: requestOptions,
