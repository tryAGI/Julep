...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_UsersRouteCreateSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_UsersRouteCreateSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_UsersRouteCreateSecurityRequirement0,
            };
        partial void PrepareUsersRouteCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Julep.UsersCreateUserRequest request);
        partial void PrepareUsersRouteCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Julep.UsersCreateUserRequest request);
        partial void ProcessUsersRouteCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUsersRouteCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.UsersUser> UsersRouteCreateAsync(

            global::Julep.UsersCreateUserRequest request,
            global::Julep.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UsersRouteCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.UsersUser>> UsersRouteCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUsersRouteCreateArguments(
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UsersRouteCreateSecurityRequirements,
                operationName: "UsersRouteCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUsersRouteCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UsersRouteCreate",
                                methodName: "UsersRouteCreateAsync",
                                pathTemplate: "\"/users\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUsersRouteCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUsersRouteCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UsersRouteCreateAsync(
                request: __request,
                requestOptions: requestOptions,
