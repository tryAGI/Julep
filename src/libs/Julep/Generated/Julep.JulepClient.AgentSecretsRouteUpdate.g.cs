...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        {
            var __response = await AgentSecretsRouteUpdateAsResponseAsync(
                id: id,
                childId: childId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.SecretsSecret>> AgentSecretsRouteUpdateAsResponseAsync(
            global::System.Guid id,
            global::System.Guid childId,
