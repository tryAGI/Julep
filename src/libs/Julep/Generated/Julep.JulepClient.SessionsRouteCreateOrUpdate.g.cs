...
namespace Julep
{
    public partial class JulepClient
    {
        ...
        private static readonly global::Julep.EndPointSecurityRequirement s_SessionsRouteCreateOrUpdateSecurityRequirement0 =
        ...
        private static readonly global::Julep.EndPointSecurityRequirement[] s_SessionsRouteCreateOrUpdateSecurityRequirements =
            new global::Julep.EndPointSecurityRequirement[]
            {                s_SessionsRouteCreateOrUpdateSecurityRequirement0,
            };
        partial void PrepareSessionsRouteCreateOrUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id,
            global::Julep.SessionsCreateSessionRequest request);
        partial void PrepareSessionsRouteCreateOrUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id,
            global::Julep.SessionsCreateSessionRequest request);
        partial void ProcessSessionsRouteCreateOrUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSessionsRouteCreateOrUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Julep.SessionsSession> SessionsRouteCreateOrUpdateAsync(
            global::System.Guid id,
        ...
        {
            var __response = await SessionsRouteCreateOrUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Julep.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Julep.AutoSDKHttpResponse<global::Julep.SessionsSession>> SessionsRouteCreateOrUpdateAsResponseAsync(
            global::System.Guid id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSessionsRouteCreateOrUpdateArguments(
            ...
            var __authorizations = global::Julep.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SessionsRouteCreateOrUpdateSecurityRequirements,
                operationName: "SessionsRouteCreateOrUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSessionsRouteCreateOrUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Julep.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Julep.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SessionsRouteCreateOrUpdate",
                                methodName: "SessionsRouteCreateOrUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSessionsRouteCreateOrUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Julep.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSessionsRouteCreateOrUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Julep.SessionsSession.FromJson<global::Julep.SessionsSession>(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Julep.AutoSDKHttpResponse<global::Julep.SessionsSession>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Julep.SessionsSession.FromJsonStreamAsync<global::Julep.SessionsSession>(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SessionsRouteCreateOrUpdateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
